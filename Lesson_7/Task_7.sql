...
UNIQUE unique_name(name(10)) ) COMMENT = 'Разделы интернет-магазина';
...
CREATE TABLE rubrics ( id SERIAL PRIMARY KEY,
...
-- здесь ругается на все столбцы "Unknown column 'products.name' in 'field list'"
SELECT
...
-- После применения алиасов запрос отработал корректно
